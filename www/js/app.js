...
.config(function($stateProvider, $sceDelegateProvider, $urlRouterProvider, $ionicConfigProvider, uiGmapGoogleMapApiProvider) {
 ...
 $sceDelegateProvider.resourceUrlWhitelist([
       ...
       'http://tradeoff-analytics-nodejs-waterlevel-035.mybluemix.net/**']);
    ...
    */
    ...
    .state('login', {
     ...
     .state('app.graph', {
        ...
        views: {
            'menuContent': {
                templateUrl: 'templates/dashboard/graph.html',
     ...
     .state('app.history', {
       ...
       .state('app.analysis', {
        ...
        views: {
            'menuContent': {
                templateUrl: 'templates/dashboard/analysis.html',
